...
1. Главный администратор: имеет полный доступ ко всем файлам. Должен управлять всем проектом и каждым рабочим в частности. Для полного соответствия с требованиями заказчика, коммуницировать с ним по ходу движения всего проекта.
